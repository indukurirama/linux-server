...
#### Creating grader User:
  ...
  * How to create user grader  and how to install  python-pip   commands is refered from git hub repository [(https://github.com/anumsh/Linux-Server-Configuration)]
